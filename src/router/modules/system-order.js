...
const systemOrder = {
  ...
  children: [
    ...
    },
    {
      ...
      component: () => import('@/views/system-order/order-refund-return'),
      name: '订单退款退货',
      meta: { title: '订单退款退货', icon: 'my-user', noCache: true, resources: 'user' }
    },
    {
      path: 'order-detail',
    ...
    {
      path: 'order-refund-return-detail',
      component: () => import('@/views/system-order/order-refund-return-detail'),
      name: '订单退款退货详情',
      meta: { title: '订单退款退货详情', icon: 'my-sysmenu', noCache: true, resources: 'category' },
      hidden: true
    },
  ]
};
